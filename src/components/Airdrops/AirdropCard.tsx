...
export const AirdropCard: React.FC<AirdropCardProps> = ({ airdrop, to }) => {
  ...
  return (
    <Link to={to} className="block h-full relative z-20">
      <motion.div
        whileHover={{ y: -4, transition: { duration: 0.2 } }}
        className="bg-[#1A1B1E] rounded-2xl p-6 border border-gray-800 hover:border-[#00E272]/50 transition-colors group flex flex-col h-full"
      >
