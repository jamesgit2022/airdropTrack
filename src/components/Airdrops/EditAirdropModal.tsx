...
interface EditAirdropModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUpdate: (id: string, updates: Partial<Airdrop>) => Promise<any>;
  airdrop: Airdrop;
}

export const EditAirdropModal: React.FC<EditAirdropModalProps> = ({ isOpen, onClose, onUpdate, airdrop }) => {
  ...
  useEffect(() => {
    if (airdrop) {
      setFormData({
        ...
        participants_count: airdrop.participants_count,
        chain: airdrop.chain,
        description: airdrop.description,
        instruction: airdrop.instruction,
        est_value: airdrop.est_value,
        date: airdrop.date,
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
        ...
        >
          <div className="flex justify-between items-center p-6 border-b border-gray-800">
            <h2 className="text-xl font-bold text-white">Edit Airdrop</h2>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="pt-4">
              ...
              >
                {loading ? 'Updating...' : 'Update Airdrop'}
              </button>
            </div>
          </form>
        </motion.div>
